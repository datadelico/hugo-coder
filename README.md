...
- **Hugo** >= 0.161.1 (extended edition recommended)
- **Node.js** >= 24.0.0 (required only if using PostCSS, Babel, or TailwindCSS)
- **Git** (for theme updates and submodule management)

> **Note:** Node.js is only required if you plan to use advanced CSS processing features. Most users using this theme do not need Node.js installed.
